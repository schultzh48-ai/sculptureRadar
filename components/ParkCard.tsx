    ...
    >
      <div>
        <div className="flex justify-between items-start mb-3">
          ...
          {park.isAiDiscovered && (
            <span className="text-[9px] text-blue-500 font-bold bg-blue-50 px-2 py-1 rounded-lg border border-blue-100">AI</span>
          )}
        </div>
      ...
      <div className="pt-4 flex items-center justify-between">
        <span className="text-[10px] font-black text-stone-900 uppercase tracking-widest">Details</span>
